...
const QUESTIONS = [
  ...
  {
    id: 'decisions',
    question: 'How are decisions made in your workflow?',
    options: [
      { label: 'Rule-based — clear if/then logic', score: 0 },
      { label: 'Mostly rules with some judgment calls', score: 1 },
      { label: 'Context-dependent — need to assess situation first', score: 2 },
      { label: 'Highly contextual — right action depends on what you discover', score: 3 },
    ],
  },
  {
    id: 'variability',
    question: 'How varied are the inputs and scenarios you handle?',
    options: [
  ...
  {
    id: 'learning',
    question: 'Should repeated tasks get easier over time?',
    options: [
      { label: 'No — each task is independent', score: 0 },
      { label: 'Nice to have but not critical', score: 1 },
      { label: 'Yes — patterns should be recognized', score: 2 },
      { label: 'Critical — the 1000th task should be much easier than the 1st', score: 3 },
    ],
  },
  {
    id: 'determinism',
  ...
  {
    id: 'governance',
    question: 'Do you need audit trails and explainability?',
    options: [
      { label: 'No — internal tooling only', score: 0 },
      { label: 'Nice to have for debugging', score: 1 },
      { label: 'Yes — need to understand what happened', score: 2 },
      { label: 'Critical — regulated industry or compliance requirements', score: 3 },
    ],
  },
];
