...
const PROBLEM_PATTERNS = [
  {
    slug: 'many-sources',
    title: 'Many Sources, Each Different',
    subtitle: 'The long-tail integration problem',
    description: "You integrate with 50+ external systems — vendors, carriers, portals, partners. Each has different formats, different UIs, different quirks. Static integrations mean N scripts to maintain, each breaking independently.",
    examples: ['Vendor portals', 'Insurance carriers', 'Healthcare providers', 'Government agencies', 'Supplier networks'],
    color: '#8b5cf6',
  },
  {
    slug: 'context-assembly',
    title: 'Workflows That Assemble Context',
    subtitle: 'The dynamic decision problem',
    description: "The right action depends on data from multiple systems. You can't predetermine the exact steps — it depends on what you find. Static branching becomes unmaintainable if/else trees.",
    examples: ['Loan underwriting', 'Claims adjudication', 'Support ticket resolution', 'Compliance checks', 'Risk assessment'],
    color: '#0ea5e9',
  },
  {
    slug: 'repeated-tasks',
    title: 'The Same Task, 1000 Times',
    subtitle: 'The learning problem',
    description: "You process the same type of task repeatedly — claims, tickets, documents, applications. Each instance is slightly different. The 1000th should be easier than the 1st, but with static automation it isn't.",
    examples: ['Document processing', 'Application intake', 'Invoice reconciliation', 'Data extraction', 'Record retrieval'],
    color: '#10b981',
  },
  {
    slug: 'external-change',
    title: "Systems You Don't Control",
    subtitle: 'The adaptation problem',
    description: "External portals redesign, APIs change, formats evolve. Your automation breaks; you scramble to fix. You want adaptation, not just alerts.",
    examples: ['Web scraping', 'Portal automation', 'Third-party integrations', 'Regulatory submissions', 'Partner data feeds'],
    color: '#f59e0b',
  },
];

const GOOD_FIT = [
  'You integrate with 20+ external systems',
  'Those systems change frequently (portals redesign, APIs evolve)',
  'You process varied inputs (not one fixed template)',
  'You need audit trails and governance',
  'The same task type repeats thousands of times',
  'Knowledge should compound — the 1000th task should be easier',
];

const NOT_FIT = [
  'You have fewer than 10 stable API integrations',
